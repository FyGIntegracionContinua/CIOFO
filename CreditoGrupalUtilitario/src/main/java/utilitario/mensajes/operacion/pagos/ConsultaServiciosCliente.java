...
@XmlRootElement(name = "ConsultaServiciosCliente")
public class ConsultaServiciosCliente {

	/**
	 * Instancia una nueva consulta servicios cliente.
	 */
	public ConsultaServiciosCliente() { }
    /** The clave cliente. */
