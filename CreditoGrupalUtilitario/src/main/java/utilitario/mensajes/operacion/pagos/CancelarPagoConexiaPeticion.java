 ...
 *
 */
public class CancelarPagoConexiaPeticion extends ObjetoValor {



	/**
	 * CancelarPagoConexiaPeticion
	 */
	public CancelarPagoConexiaPeticion() {
		super();
	}
	/**
	 * serialVersionUID long
	 */
	private static final long serialVersionUID = 5897267440401645848L;
	/**
