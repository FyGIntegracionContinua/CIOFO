...
@XmlRootElement(name = "ConsultaClienteTalonario")
public class ConsultaClienteTalonario {

	/**
	 * Instancia una nueva consulta cliente talonario.
	 */
	public ConsultaClienteTalonario() { }
    /** The contrato. */
