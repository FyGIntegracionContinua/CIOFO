...
@XmlRootElement(name = "CancelarPagoReferenciado")
public class CancelarPagoReferenciado {

	/**
	 * Instancia una nueva cancelar pago referenciado.
	 */
	public CancelarPagoReferenciado() { }
    /** The contrato. */
