...
/**
 * The Class ConsultaSaldosAFavorAjustadosRespuesta.
 */
public class ConsultaSaldosAFavorAjustadosRespuesta extends 	ObjetoValor  {
		...
		//Constructor  --------------------------------------------------------------------------
		/**
		 * Instancia una nueva consulta saldos a favor ajustados respuesta.
		 */
